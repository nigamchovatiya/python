"""
here i extract 1-5 pages of books.toscrape.com
using a loop and save csv and json.
"""
...
for page in range(1, 6): # 1-5 page
    ...
    time.sleep(2) # 2 sec delay before new request    
