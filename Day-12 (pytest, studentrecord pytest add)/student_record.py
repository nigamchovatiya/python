...
def student_record_add(student_detail_list: list, name: str,
                        rollno: str, marks: str) -> None:
    """
...
def student_search(student_detail_list: list, name: str, marks: str) -> None:
    """
    ...
    for student in student_detail_list:
        ...
        if student['name'] == name and student['marks'] == marks:
            print(student_detail_list) 
            return student   
        else:
            pass
...
def student_delete(student_detail_list: list, name: str) -> None:
    """
...
def main() -> None:
    ...
    while True:
        ...
        if choice == 0:
            ...
            student_record_add( student_detail_list, name = "john",
                                rollno = "7458123690", marks = "95")

        elif choice == 2:
            student_list(student_detail_list)

        elif choice == 3:
            student_search(student_detail_list, name = "john", marks="95")    

        elif choice == 4:
            student_delete(student_detail_list, name = "john")  
